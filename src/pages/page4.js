...
import pizzawhole from '../images/pizzaWhole.png'
...
const PizzaGo = () => (
  <Layout>
    ...
    <div className="pizzaGoSummary">
      <p>My Role for this project was to Design and Develop an E-Commerce Static Site for a Medium sized business in Las Vegas that allowed customers to order Pizza, Ribs, and other great foods for delivery. Customers also have the ability to Create Accounts and Log in to save information from previous orders.</p>
      </div>

       <h2 className="headerSub"> Tools I used to Design <br/> & bring this to Life?  </h2>



        <div className="pizzaGoSummary">
      <p>I used <a href="https://www.sketchapp.com/">Sketch</a> to Design my UI. <a href="https://zeplin.io/">Zeplin</a> to export my assets with styleguides, accurate specs, assets, & code snippets.<br/>
      With <a href="https://reactjs.org/">React.js</a> I used <a href="https://www.gatsbyjs.org/">Gatsby.js</a> as my Static Site framework. <a href="https://www.contentful.com/">Contenful</a> as my CMS. <a href="https://moltin.com/">Moltin E-Commerce</a> API. <a href="https://stripe.com/">Stripe</a> for my secured payments. Deploying this site via <a href="https://www.netlify.com/">Netlify</a>. 
      </p>
      </div>
